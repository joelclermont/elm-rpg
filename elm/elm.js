...
var _user$project$Main$drawPlayer = function (player) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$fill('#00FFFF'),
				_elm_lang$svg$Svg_Attributes$x('0'),
				_elm_lang$svg$Svg_Attributes$y('0'),
				_elm_lang$svg$Svg_Attributes$width(
				_elm_lang$core$Basics$toString(_user$project$Main$playerWidth)),
				_elm_lang$svg$Svg_Attributes$height(
				_elm_lang$core$Basics$toString(_user$project$Main$playerHeight))
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
...
var _user$project$Main$drawMapTile = F3(
	function (yPos, xPos, tile) {
		var _p0 = tile;
		if (_p0.ctor === 'WaterTile') {
			return A2(
				_elm_lang$svg$Svg$rect,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Basics$toString(
							_elm_lang$core$Basics$toFloat(xPos) * _user$project$Main$tileWidth)),
						_elm_lang$svg$Svg_Attributes$y(
						_elm_lang$core$Basics$toString(
							_elm_lang$core$Basics$toFloat(yPos) * _user$project$Main$tileHeight)),
						_elm_lang$svg$Svg_Attributes$width(
						_elm_lang$core$Basics$toString(_user$project$Main$tileWidth)),
						_elm_lang$svg$Svg_Attributes$height(
						_elm_lang$core$Basics$toString(_user$project$Main$tileHeight))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]));
		} else {
...
var _user$project$Main$drawMapRow = F2(
	function (y, row) {
		return A2(
			_elm_lang$svg$Svg$g,
			_elm_lang$core$Native_List.fromArray(
			...
			A2(
				...
				_user$project$Main$drawMapTile(y),
				row));
	});
var _user$project$Main$drawMap = F2(
	function (map, _p1) {
		...
		var moveMapX = _elm_lang$core$Basics$negate(_p2._0);
		return A2(
			_elm_lang$svg$Svg$g,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(moveMapX),
							A2(
								_elm_lang$core$Basics_ops['++'],
								',',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(moveMapY),
									')')))))
				]),
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {player: a, map: b, keyboardModel: c};
	});
var _user$project$Main$Player = F3(
	function (a, b, c) {
		return {x: a, y: b, speed: c};
	});
var _user$project$Main$Map = F3(
	function (a, b, c) {
		return {width: a, height: b, tiles: c};
	});
...
var _user$project$Main$init = function () {
	...
	return {
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$KeyboardExtraMsg, keyboardCmd),
					A2(
					_elm_lang$core$Random$generate,
	...
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'KeyboardExtraMsg':
				var _p6 = A2(_ohanhi$keyboard_extra$Keyboard_Extra$update, _p5._0, model.keyboardModel);
				var keyboardModel = _p6._0;
				var keyboardCmd = _p6._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{keyboardModel: keyboardModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$KeyboardExtraMsg, keyboardCmd)
				};
			case 'Tick':
				var oldPlayer = model.player;
				var _p7 = _ohanhi$keyboard_extra$Keyboard_Extra$arrows(model.keyboardModel);
				var x = _p7.x;
				var y = _p7.y;
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
				var oldMap = model.map;
				var newMap = _elm_lang$core$Native_Utils.update(
					oldMap,
					{tiles: _p5._0});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$KeyboardExtraMsg, _ohanhi$keyboard_extra$Keyboard_Extra$subscriptions),
