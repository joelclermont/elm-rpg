...
var _user$project$Main$drawMapTile = F2(
	function (x, tile) {
		var _p0 = tile;
		if (_p0.ctor === 'WaterTile') {
			return A2(
				_evancz$elm_graphics$Collage$moveX,
				_elm_lang$core$Basics$toFloat(x) * _user$project$Main$tileWidth,
				A2(
					_evancz$elm_graphics$Collage$filled,
					A3(_elm_lang$core$Color$rgb, 0, 0, 255),
					A2(_evancz$elm_graphics$Collage$rect, _user$project$Main$tileWidth, _user$project$Main$tileHeight)));
		} else {
			return A2(
				_evancz$elm_graphics$Collage$moveX,
				_elm_lang$core$Basics$toFloat(x) * _user$project$Main$tileWidth,
...
var _user$project$Main$drawMapRow = F2(
	function (y, row) {
		return A2(
			...
			_elm_lang$core$Basics$toFloat(y) * _user$project$Main$tileHeight,
			_evancz$elm_graphics$Collage$group(
				A2(_elm_lang$core$List$indexedMap, _user$project$Main$drawMapTile, row)));
	});
